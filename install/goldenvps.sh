...
fun_ip
wget -O /usr/bin/trans https://www.dropbox.com/s/osocw5k6msslgpa/trans?dl=0 &> /dev/null
msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "EU SOU DEADSHOT, OBRIGADO POR USAR"|sed -e 's/[^a-z -]//ig') \033[93m[GOLDEN ADM PRO]"
