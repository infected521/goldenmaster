...
echo -e "$BARRA1"
    read -p "(Contrasena predeterminada: hendrix):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="hendrix"
    echo "--------------------------------------"
...
install_prepare_manager(){
    ...
    read -p "(Contrasena predeterminada: hendrix):" manager_password
    [ -z "${manager_password}" ] && manager_password="hendrix"
...
clear
echo -e "$BARRA1"
echo && echo -e " ${blan_font_prefix}TCP-BBR-LOTSERVER${Font_color_suffix} ${Green_font_prefix}NEW-AMD${Font_color_suffix} ${blan_font_prefix}by${Font_color_suffix} ${blue_font_prefix}LA CASITA DEL TERRORR${Font_color_suffix}  ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
"${BARRA1}" 
